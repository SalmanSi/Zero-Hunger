...
const AdminDashboard = () => {
    ...
    const distributionData = [
        { name: 'Grand Bistro', amount: 450, color: '#16a34a' },
        { name: 'Street Flavors', amount: 320, color: '#22c55e' },
        { name: 'Urban Kitchen', amount: 280, color: '#4ade80' },
        { name: 'Cafe Sky', amount: 150, color: '#86efac' },
    ];
                ...
                <header className="mb-12 flex justify-between items-end">
                    ...
                    <div className="flex gap-4">
                        <div className="bg-white px-4 py-2 rounded-xl border border-outline-variant/10 flex items-center gap-2">
                            ...
                            <span className="text-xs font-bold text-on-surface uppercase tracking-tight">+12% this week</span>
                        </div>
                    </div>
                </header>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    ...
                    <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-outline-variant/10 relative overflow-hidden group hover:-translate-y-1 transition-all">
                        <div className="relative z-10">
                            ...
                            <p className="text-4xl font-black tracking-tighter text-orange-600">{pendingUsers.length}</p>
                        </div>
                        <AlertCircle className="absolute -right-4 -bottom-4 text-orange-50 w-32 h-32 -rotate-12 group-hover:scale-110 transition-transform" strokeWidth={1} />
                    </div>
                    <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-outline-variant/10 relative overflow-hidden group hover:-translate-y-1 transition-all">
                        <div className="relative z-10">
                                    ...
                                    {pendingUsers.length === 0 ? (
                                        ...
                                        pendingUsers.map(user => (
                                            <tr key={user.id} className="hover:bg-surface-container-low/30 transition-colors group">
                                                ...
                                                <td className="px-8 py-6">
                                                    <span className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase ${user.role === 'PROVIDER' ? 'bg-blue-50 text-blue-600' : 'bg-orange-50 text-orange-600'}`}>
                                                        {user.role}
                                                    </span>
                                                </td>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        <section className="lg:col-span-8 bg-white p-10 rounded-[2.5rem] shadow-sm border border-outline-variant/10">
                            ...
                            <div className="mt-12 pt-8 border-t border-outline-variant/5 grid grid-cols-3 gap-8">
                                ...
                                <div>
                                    <p className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest mb-1">Growth</p>
                            ...
                            <div className="relative w-48 h-48 mb-8">
                                <svg viewBox="0 0 100 100" className="w-full h-full -rotate-90">
                                    ...
                                    <circle
                                        ...
                                        stroke="#16a34a"
                                        strokeWidth="15"
                                        strokeDasharray={`${(userStats.providers / users.length) * 251.2} 251.2`}
                                    ...
                                    <circle
                                        ...
                                        stroke="#0f172a"
                                        strokeWidth="15"
                                        strokeDasharray={`${(userStats.ngos / users.length) * 251.2} 251.2`}
                                        strokeDashoffset={`-${(userStats.providers / users.length) * 251.2}`}
                                        className="transition-all duration-1000"
                                    />
                                </svg>
